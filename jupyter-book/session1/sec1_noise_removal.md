...
**소요 시간**: 45분 (문제 제기 3 + 이론 12 + 시연 10 + 실습 20)
:::
...
:::{admonition} 참고 교재
:class: note
📖 *Think DSP* **Ch.1 Sounds and Signals** — 신호의 정의와 주파수 표현 / **Ch.3 Non-periodic Signals** — FFT의 한계와 비정상 신호 문제
:::
...
:::{admonition} 참고 교재
:class: note
📖 *Think DSP* **Ch.8 Filtering and Convolution** — 필터의 원리와 주파수 선택 / **Ch.4 Noise** — 노이즈의 정의와 스펙트럼 특성
:::
...
:::{admonition} 참고 교재
:class: note
📖 *Think DSP* **Ch.8 Filtering and Convolution** — 저역통과/고역통과 필터와 주파수 성분 선택의 원리
:::
...
### ④ pywt 라이브러리 핵심 함수 3개 (3분)

:::{admonition} 참고 교재
:class: note
📖 *Think DSP* **Ch.8 Filtering and Convolution** — 필터 구현 실습 / Appendix — Python 신호처리 라이브러리 활용
:::
