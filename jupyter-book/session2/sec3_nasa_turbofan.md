...
```{figure} ../../lecture/images/s2_3_img01.png
:alt: NASA Turbofan 데이터셋 구조
:width: 67%

NASA Turbofan 데이터셋 구조
```
...
```{figure} ../../lecture/images/s2_3_img04.png
:alt: 센서별 시계열 플롯
:width: 67%

센서별 시계열 플롯
```
```{figure} ../../lecture/images/s2_3_img05.png
:alt: 센서 상관관계 히트맵
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img07.png
:alt: RUL 클리핑 전후 분포 비교
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img09.png
:alt: 센서별 RUL과의 상관관계
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img10.png
:alt: 시계열 정상성 검정 결과
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img14.png
:alt: LSTM 학습 곡선
:width: 67%

LSTM 학습 곡선
```
```{figure} ../../lecture/images/s2_3_img16.png
:alt: 실제 RUL vs 예측 RUL 비교
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img17.png
:alt: RMSE vs NASA Score 비교
:width: 67%

RMSE vs NASA Score 비교
```
```{figure} ../../lecture/images/s2_3_img18.png
:alt: 비대칭 손실 함수 시각화
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img21.png
:alt: 특징 공학: 파생 특징 예시
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img29.png
:alt: FD001 vs FD002 센서 분포 비교
:width: 67%

FD001 vs FD002 센서 분포 비교
```
```{figure} ../../lecture/images/s2_3_img32.png
:alt: 운전 조건에 따른 센서 범위 차이
:width: 67%
...
```{figure} ../../lecture/images/s2_3_img39.png
:alt: LSTM 예측 결과: 엔진별 RUL 궤적
:width: 67%

LSTM 예측 결과: 엔진별 RUL 궤적
```
```{figure} ../../lecture/images/s2_3_img40.png
:alt: 이상 탐지 결과: 재구성 오차 히트맵
:width: 67%
