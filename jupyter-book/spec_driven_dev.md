...
```{raw} html
<div class="sd-container-fluid" style="margin: 1.5em 0;">
  <div class="sd-row sd-row-cols-4 sd-g-4 sd-text-center" style="align-items:stretch;">
    <div class="sd-col">
      <div class="sd-card sd-rounded-3 sd-shadow-sm" style="padding:1em; background:#e8f0fe; min-height:100%;">
        <div style="font-size:1.3em; font-weight:700; color:#1a73e8;">① PRD</div>
        <div style="margin-top:.5em; font-size:.9em;">문제 정의<br>메트릭<br>제약사항</div>
      </div>
    </div>
    <div class="sd-col">
      <div class="sd-card sd-rounded-3 sd-shadow-sm" style="padding:1em; background:#e6f4ea; min-height:100%;">
        <div style="font-size:1.3em; font-weight:700; color:#137333;">② Research</div>
        <div style="margin-top:.5em; font-size:.9em;">논문 탐색<br>베이스라인<br>Consensus MCP</div>
      </div>
    </div>
    <div class="sd-col">
      <div class="sd-card sd-rounded-3 sd-shadow-sm" style="padding:1em; background:#fef7e0; min-height:100%;">
        <div style="font-size:1.3em; font-weight:700; color:#b06000;">③ Quick Dev</div>
        <div style="margin-top:.5em; font-size:.9em;">핵심 코드<br>빠른 구현</div>
      </div>
    </div>
    <div class="sd-col">
      <div class="sd-card sd-rounded-3 sd-shadow-sm" style="padding:1em; background:#fce8e6; min-height:100%;">
        <div style="font-size:1.3em; font-weight:700; color:#c5221f;">④ Test</div>
        <div style="margin-top:.5em; font-size:.9em;">실험 결과<br>분석<br>개선점</div>
      </div>
    </div>
  </div>
  <div class="sd-text-center" style="margin-top:.8em; font-size:.9em; color:#5f6368;">
    ↑ ↓ 반복 (다음 이터레이션)
  </div>
</div>
```

### 3.2 ① PRD (Product Requirements Document) — 문제 정의
