...
1. 클로드에게 "환경 변수 문제가 있으니, persisting한 기록을 system environment에 추가하라고" 한 후
2. VSCODE 전체를 한번 껐다 켜주세요

### 2차 해결 방법 — 직접 추가

1. 환경 변수 → 편집 → 시스템 항목의 PATH에 `C:\Users\[std]\.local\bin` 을 추가합니다.
2. VSCODE를 한번 껐다 켜주세요
